...
import { GoldState, interestRateState, buildingState, currentPrevIssueState, currentIssueState } from '../../recoil/game/atom';
...
function EconomicIndicator({ setSideBarType }) {
    ...
    return (
        <S.EconomicIndicatorMain>
            ...
            >
                <img src='EconomicIndicator/EconomicNews.png' alt='img' style={{ height: '30px', marginRight: '5px' }} />
                <span>경제 뉴스</span>
            </div>
            {beforeBigEvent ? <BeforeBigEventNews News={beforeBigEventNews(currentPrevIssue)} /> : <AfterBigEventNews News={NewsList} />}
            ...
            >
                <img src='EconomicIndicator/Indicator.png' alt='img' style={{ height: '30px', marginRight: '5px' }} />
                <span>경제 지표</span>
            </div>
            {/* 금리 차트 */}
            <ChartSection title={interestRateTitle} imgPath={interestRate} data={interestRateData} />
            {/* 금 차트 */}
            ...
            <ChartSection title={realEstateTitle} imgPath={reaEstateImgPath} data={makebuildingData(realEstateData)} />

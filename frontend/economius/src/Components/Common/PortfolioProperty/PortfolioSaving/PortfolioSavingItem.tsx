...
function PortfolioSavingItem({ title, rate, cycleCnt, currentCycle, cycleMoney, currentPrice }) {
    return (
        <S.PropertyLayoutItem>
            ...
            <S.LayoutBottom>
                <S.LayoutBottomitem>
                    ...
                    <S.LayoutBottomitemRight>{cycleMoney.toLocaleString()}</S.LayoutBottomitemRight>
                </S.LayoutBottomitem>
                <S.LayoutBottomitem>
                    <S.LayoutBottomitemLeft>현재 납입액</S.LayoutBottomitemLeft>
                    <S.LayoutBottomitemRight>{currentPrice.toLocaleString()}</S.LayoutBottomitemRight>
                </S.LayoutBottomitem>
                <S.LayoutBottomitem>
                    <S.LayoutBottomitemLeft>납입 바퀴 / 총 납입 바퀴</S.LayoutBottomitemLeft>

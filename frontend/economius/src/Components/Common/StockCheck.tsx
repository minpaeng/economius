    ...
    return (
        <div>
            ...
            <div style={{ width: '90%', margin: 'auto' }}>
                <SideStockPrice companyCategory={companyCategory} companySubCategory={companySubCategory} price={price} rate={rate} />
                ...
                <SideStockOwnerChart remainingAmount={remainingAmount} owners={owners} />
                <div
                    style={{
                        display: 'flex',

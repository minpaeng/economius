...
// function Chicken({ positionIdx, moveDist, opacity, radius, steps }:{ positionIdx: number; moveDist: number; opacity: number; radius: number; steps: number }) {
function Chicken({ positionIdx, moveDist, opacity, radius, steps }) {
    const gltfPath = 'Chicken.gltf';

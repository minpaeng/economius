...
// function Cat({ positionIdx, moveDist, opacity, radius, steps }:{ positionIdx: number; moveDist: number; opacity: number; radius: number; steps: number }) {
function Cat({ positionIdx, moveDist, opacity, radius, steps }) {
    const gltfPath = 'Cat.gltf';

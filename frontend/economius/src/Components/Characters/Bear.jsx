...
// function Bear({ positionIdx, moveDist, opacity, radius, steps }:{ positionIdx: number; moveDist: number; opacity: number; radius: number; steps: number }) {
function Bear({ positionIdx, moveDist, opacity, radius, steps }) {
    const gltfPath = 'Bear.gltf';

...
// function Cow({ positionIdx, moveDist, opacity, radius, steps }:{ positionIdx: number; moveDist: number; opacity: number; radius: number; steps: number }) {
function Cow({ positionIdx, moveDist, opacity, radius, steps }) {
    const gltfPath = 'Cow.gltf';
